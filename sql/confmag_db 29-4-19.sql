...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2019 at 09:17 PM
...
(1, 'test', 'name', '91832798389', '2019-04-09', 'Address Line 1', 'Address Line 2', 'City', '', 'http://google.com', '', '', 'ahmed.maruff@gmail.com', 'bsVk4ckHDHjnVMCz14y8NBmxcP/pwU', 0),
(2, 'test', 'uiqwhuiqw', '91832798389', '2019-04-09', 'Address Line 1', 'Address Line 2', 'City', 'Country', '', '', '', 'black.dmond143@gmail.com', 'bsVk4ckHDHjnVMCz14y8NBmxcP/pwU', 0),
(3, 'test', 'encrypt', '91832798389', '2019-04-09', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'maruf@gmail.com', 'bsVk4ckHDHjnVMCz14y8NBmxcP/pwU', 0),
(7, 'sadad', 'jadjkhas', '981723981293', '2019-04-09', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'maruf.hh007@gmail.com', '2smRbx/Coa7HhLFgFUnBDyPTeToQu3', 0);
...
(115563015851, 'test unique id file', 'test,unique', '<p>test unique id file</p>', 1, '', NULL, '2019-04-26 17:59:45', 0),
...
(21, 'test', 'rev', '91832798389', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'rev1@gmail.com', '123', 0),
...
--
ALTER TABLE `paper_author`
  MODIFY `paper_author_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;

--
-- AUTO_INCREMENT for table `paper_files`
--
ALTER TABLE `paper_files`
  MODIFY `paper_file_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `paper_reviewer`
--
ALTER TABLE `paper_reviewer`
  MODIFY `paper_reviewer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
...
--
ALTER TABLE `review_history`
  MODIFY `review_history_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
